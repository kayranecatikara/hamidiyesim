"""
vision_training/train_yolo.py — Otomatik etiketli veriyle YOLO nano modeli eğitir.
...
def main():
    ...
    ap.add_argument("--data", default="vision_training/datasets/talon/dataset.yaml")
    ...
    if not os.path.exists(args.data):
        raise SystemExit(f"dataset.yaml yok: {args.data}\n"
                         f"Önce veri topla: python3 -m vision_training.capture_dataset")
