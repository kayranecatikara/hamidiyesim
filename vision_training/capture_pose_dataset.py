"""
vision_training/capture_pose_dataset.py — Gazebo statik world'de OTOMATİK ETİKETLİ YOLO-POSE verisi.
...
from vision_training.capture_dataset import (
...
def main():
    ...
    ap.add_argument("--out", default="vision_training/datasets/talon_pose")
    ...
    import vision_training.capture_dataset as _cd
