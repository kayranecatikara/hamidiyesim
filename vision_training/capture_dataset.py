"""
vision_training/capture_dataset.py — Gazebo statik world'de OTOMATİK ETİKETLİ YOLO verisi toplar.
...
def main():
    ...
    ap.add_argument("--out", default="vision_training/datasets/talon")
