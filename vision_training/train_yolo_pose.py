"""
vision_training/train_yolo_pose.py — Otomatik etiketli pose verisiyle YOLO-pose modeli eğitir.
...
def main():
    ...
    ap.add_argument("--data", default="vision_training/datasets/talon_pose/dataset.yaml")
