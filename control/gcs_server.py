...
# (PnP "tahmini" endpoint'i KALDIRILDI — 2026-08-02, kullanıcı kararı.
#  Ground-truth'a yapay gürültü ekleyip ölçüm gibi sunuyordu; ekip PR#4'te de
#  aynı tespit yapıldı. Gerçek algı verileri detection/pose/tracker zincirinde.)
