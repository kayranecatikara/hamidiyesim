...
Amaç: hard-negative kare toplarken (vision_training/capture_negatives.py) drone'un kendi
...
Kullanım (simülasyon + SITL çalışırken):
    ...
    python3 -m demos.run_drone_square                # varsayılan: 25m irtifa, 40m kenar
    python3 -m demos.run_drone_square --alt 30 --side 60
