...
Kullanım:
    python -m demos.run_plane_scenario square      # kare çiz
    python -m demos.run_plane_scenario circle      # daire çiz
    python -m demos.run_plane_scenario aggressive  # rastgele agresif manevralar
...
from vehicle_control.plane_functions import (
    connect_plane,
    arm_plane,
    get_conn,
    start_gcs_keepalive,
