...
- Force arm magic 2989'dur (mavlink_common.arm halleder)
...
def arm_plane(warmup_duration: float = 3.0):
    ...
    # Force ARM (ArduPilot magic 2989, mavlink_common halleder)
...
def loiter(duration: float = 5.0):
    ...
    (Gerçek LOITER modu için mavlink_common.set_mode(conn, PLANE_MODE_LOITER)
